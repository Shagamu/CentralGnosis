...
@WebServlet(name = "CarregarBibliotecaLivro", urlPatterns = {"/CarregarBibliotecaLivro"})
public class CarregarBibliotecaLivro extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sessao.getAttribute("bibliotecario") != null) {
                ...
                try {
                    ...
                    GenericDAO dao = new AdminDAOImpl();
