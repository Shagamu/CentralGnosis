...
import br.com.projetobiblioteca.dao.GeneroDAOImpl;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sessao.getAttribute("bibliotecario") != null) {
                ...
                try {
                    ...
                    GeneroLivroDAOImpl daogeneros = new GeneroLivroDAOImpl();
                    request.setAttribute("generoslivro", daogeneros.listarGeneros(idLivro));
