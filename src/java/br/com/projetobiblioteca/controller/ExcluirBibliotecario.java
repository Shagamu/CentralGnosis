...
@WebServlet(name = "ExcluirBibliotecario", urlPatterns = {"/ExcluirBibliotecario"})
public class ExcluirBibliotecario extends HttpServlet {
            ...
            if (sessao.getAttribute("bibliotecario") != null) {
                ...
                try {
                    ...
                    if (dao.excluir(idPessoa)) {
                        ...
                        mensagem = "Problemas ao excluir bibliotecário!";
                    }
