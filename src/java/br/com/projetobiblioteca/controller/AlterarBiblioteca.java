...
@WebServlet(name = "AlterarBiblioteca", urlPatterns = {"/AlterarBiblioteca"})
public class AlterarBiblioteca extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sessao.getAttribute("bibliotecario") != null) {
                ...
                try {
                    ...
                    if (dao.alterar(biblioteca)) {
                        mensagem = "Biblioteca alterada com sucesso!";
                    } else {
                        mensagem = "Problemas ao alterar Biblioteca. "
                                + "Verifique os dados informados e tente novamente!";
                    }
                    request.setAttribute("mensagem", mensagem);
                    request.getRequestDispatcher("CarregarBiblioteca").forward(request, response);
                } catch (Exception ex) {
                    System.out.println("Problemas no Servlet ao alterar Biblioteca! Erro: " + ex.getMessage());
                    ex.printStackTrace();
                }
            } else {
